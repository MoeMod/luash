...
local function EV_FireGALIL( args )
	...
	if EV_IsLocal( idx ) then
		...
		local seq = RandomLong(galil_e.GALIL_SHOOT1, galil_e.GALIL_SHOOT3)
	...
	EV_PlaySound(idx, origin, CHAN_WEAPON, (RandomLong(0, 1) == 1 and "weapons/galil-1.wav" or "weapons/galil-2.wav"), 1.0, ATTN_NORM, 0, 94 + RandomLong(0, 0xf))
